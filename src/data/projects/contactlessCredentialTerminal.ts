...
## 42dot OTA 직무와의 접점
- 제약이 있는 임베디드 단말에서 프로토콜, 보안 처리, 예외 응답을 함께 고려한 개발 경험
- 고객/운영 환경별 사양 차이를 분석하고 일관된 단말 동작으로 구현한 경험
- 카드 인식 실패, 재시도, 예외 응답 등 상태 기반 흐름을 안정화한 경험
- 업데이트 시스템에서도 중요한 검증, 상태 관리, 예외 처리 관점의 단말 소프트웨어 경험`,
  highlights: [
